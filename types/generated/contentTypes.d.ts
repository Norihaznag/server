...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    phone: Attribute.String &
      ...
      Attribute.DefaultTo<'0601020303'>;
...
export interface ApiDishDish extends Schema.CollectionType {
  ...
  attributes: {
    ...
    tags: Attribute.Relation<'api::dish.dish', 'manyToMany', 'api::tag.tag'>;
    thumbnail: Attribute.Media<'images'>;
...
export interface ApiTagTag extends Schema.CollectionType {
  ...
  attributes: {
    ...
    dishes: Attribute.Relation<'api::tag.tag', 'manyToMany', 'api::dish.dish'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
